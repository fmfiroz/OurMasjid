...
public class GothonTontro_1 extends AppCompatActivity {
    ...
    public void init(){
        ...
        but5=(TextView)findViewById(R.id.but5);
        but6=(TextView)findViewById(R.id.but6);
        but7=(TextView)findViewById(R.id.but7);
        but8=(TextView)findViewById(R.id.but8);
        but9=(TextView)findViewById(R.id.but9);
        but10=(TextView)findViewById(R.id.but10);
        but11=(TextView)findViewById(R.id.but11);
        but12=(TextView)findViewById(R.id.but12);
        but13=(TextView)findViewById(R.id.but13);
        but14=(TextView)findViewById(R.id.but14);
        but15=(TextView)findViewById(R.id.but15);
        but16=(TextView)findViewById(R.id.but16);
        but17=(TextView)findViewById(R.id.but17);
        but18=(TextView)findViewById(R.id.but18);
        but19=(TextView)findViewById(R.id.but19);
        but20=(TextView)findViewById(R.id.but20);
        but21=(TextView)findViewById(R.id.but21);
        but22=(TextView)findViewById(R.id.but22);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gothon_tontro_1);
        init();
    }
}
